...
new_str = '''
      <section className="w-full px-4 md:px-8 mt-6 mb-16">
        <div className="max-w-[1000px] mx-auto bg-white rounded-3xl border border-[#E2E8F0] p-6 sm:p-10 md:p-12 shadow-[0_8px_30px_rgba(15,23,42,0.04)]">
...
new_bottom_1 = '''<article className="rounded-2xl border p-6 mt-10" style={{ borderColor: `${accent}33`, backgroundColor: '#F8FAFCCC' }}>
...
new_bottom_2 = '''<article className="rounded-2xl border p-6" style={{ borderColor: `${accent}33`, backgroundColor: softAccent }}>
              <p className="font-['DM_Sans',sans-serif] text-[13px] uppercase tracking-[0.08em] font-bold" style={{ color: accent }}>AI Readiness Signal</p>'''
...
old_bottom_3 = '''<article className="rounded-2xl border bg-white p-5 shadow-[0_8px_24px_rgba(15,23,42,0.04)]" style={{ borderColor: `${accent}33` }}>
              <p className="font-['DM_Sans',sans-serif] text-[14px] text-[#475569] mb-4">
                Explore the other'''
new_bottom_3 = '''<article className="rounded-2xl border border-gray-200 bg-white p-6 md:p-8 shadow-sm mt-8">
