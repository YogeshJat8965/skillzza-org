...
with open('frontend/src/pages/SkillzzaLiveSessionPage.jsx', 'r') as f:
    text = f.read()
...
old_article_2 = '''              <article className="rounded-2xl border border-[#E7EAF0] bg-white p-6 sm:p-8 shadow-[0_8px_24px_rgba(15,23,42,0.04)]">
                <h3 className="font-['DM_Sans',sans-serif] text-[24px] leading-[1.25] font-bold text-[#0F172A] mb-4">Core Takeaways</h3>'''
new_article_2 = '''              <article className="border-b border-gray-100 pb-10 last:border-0 last:pb-0">
                <div className="flex items-center gap-4 mb-6">
                  <span className="h-1.5 w-1.5 rounded-full ring-4 ring-opacity-20" style={{ backgroundColor: accent, '--tw-ring-color': accent }} />
                  <h3 className="font-['League_Spartan',sans-serif] text-[26px] md:text-[30px] leading-tight font-bold text-[#0F172A]">Core Takeaways</h3>
                </div>'''
...
old_article_3 = '''              <article className="rounded-2xl border border-[#E7EAF0] bg-white p-6 sm:p-8 shadow-[0_8px_24px_rgba(15,23,42,0.04)]">
                <h3 className="font-['DM_Sans',sans-serif] text-[24px] leading-[1.25] font-bold text-[#0F172A] mb-4">Key Action Items</h3>'''
new_article_3 = '''              <article className="border-b border-gray-100 pb-10 last:border-0 last:pb-0">
                <div className="flex items-center gap-4 mb-6">
                  <span className="h-1.5 w-1.5 rounded-full ring-4 ring-opacity-20" style={{ backgroundColor: accent, '--tw-ring-color': accent }} />
                  <h3 className="font-['League_Spartan',sans-serif] text-[26px] md:text-[30px] leading-tight font-bold text-[#0F172A]">Key Action Items</h3>
                </div>'''
text = text.replace(old_article_3, new_article_3)

with open('frontend/src/pages/SkillzzaLiveSessionPage.jsx', 'w') as f:
    f.write(text)

print("Updated SkillzzaLiveSessionPage!")
