      ...
      <div style={{ maxWidth: 1400, margin: '0 auto', padding: '0 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 8 }}>
        ...
        <div className="hidden md:flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-4 text-gray-600 text-base">
            ...
            <a
              href="https://www.instagram.com/theskillzza/"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://www.linkedin.com/company/theskillzza/?originalSubdomain=in"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="LinkedIn"
            ...
            <a
              href="https://www.youtube.com/@theskillzza/featured"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="YouTube"
