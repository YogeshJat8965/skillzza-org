          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center text-white">
              <div className="group">
                ...
                <div className="text-xl opacity-90">Global Challenges</div>
              </div>
              <div className="group">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="space-y-12">
                  ...
                  <div>
                    <div className="flex items-center mb-6">
                      ...
                      <div>
                        ...
                        <p className="text-xl text-orange-600">& Themed Innovation Sprints</p>
                      </div>
                    </div>
                  ...
                  <div className="lg:order-2">
                    <div className="flex items-center mb-6">
                      ...
                      <div>
                        ...
                        <p className="text-xl text-blue-600">From Enterprise and Public Sectors</p>
                      </div>
                    </div>
                    <ul className="space-y-3 text-gray-700 mb-6">
              ...
              <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-2xl p-8 lg:p-12 border border-yellow-200">
                ...
                <p className="text-xl text-orange-600">From Institutions, Industry Leaders, and Peers</p>
                      </div>
                    </div>
                    <ul className="space-y-3 text-gray-700 mb-6">
                  ...
                  <div className="lg:order-2">
                    <div className="flex items-center mb-6">
                      ...
                      <div>
                        ...
                        <p className="text-xl text-yellow-600">AI, Data, and Coding Skills on Leading Platforms</p>
                      </div>
                    </div>
                    <ul className="space-y-3 text-gray-700 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 group">
                ...
                <div className="text-center">
                  ...
                  <p className="text-base text-gray-600">Active Challenges</p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-gradient-to-br from-orange-50 to-yellow-50 p-8 rounded-2xl border border-orange-200">
                <div className="flex items-center mb-4">
                  ...
                  <span className="ml-2 text-base text-gray-600">Winner - Computer Vision Challenge</span>
                </div>
              ...
              <div className="bg-gradient-to-br from-yellow-50 to-orange-50 p-8 rounded-2xl border border-yellow-200">
                <div className="flex items-center mb-4">
                  ...
                  <span className="ml-2 text-base text-gray-600">Winner - NLP Challenge</span>
                </div>
                <p className="text-gray-700 mb-4 italic">
              ...
              <div className="bg-gradient-to-br from-orange-50 to-red-50 p-8 rounded-2xl border border-orange-200">
                <div className="flex items-center mb-4">
                  ...
                  <span className="ml-2 text-base text-gray-600">Winner - Healthcare AI Challenge</span>
                </div>
                <p className="text-gray-700 mb-4 italic">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
                <div className="flex items-center justify-between mb-4">
                  <span className="bg-orange-100 text-orange-800 text-base font-semibold px-3 py-1 rounded-full">
                    Starting Soon
                  </span>
                  <span className="text-base text-gray-600">Deadline: March 15, 2025</span>
                </div>
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  <span className="bg-gray-100 text-gray-700 text-sm px-2 py-1 rounded">Computer Vision</span>
                  <span className="bg-gray-100 text-gray-700 text-sm px-2 py-1 rounded">Time Series</span>
                  <span className="bg-gray-100 text-gray-700 text-sm px-2 py-1 rounded">IoT</span>
                </div>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
                <div className="flex items-center justify-between mb-4">
                  <span className="bg-yellow-100 text-yellow-800 text-base font-semibold px-3 py-1 rounded-full">
                    Registration Open
                  </span>
                  <span className="text-base text-gray-600">Deadline: April 20, 2025</span>
                </div>
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  <span className="bg-gray-100 text-gray-700 text-sm px-2 py-1 rounded">Computer Vision</span>
                  <span className="bg-gray-100 text-gray-700 text-sm px-2 py-1 rounded">Reinforcement Learning</span>
                  <span className="bg-gray-100 text-gray-700 text-sm px-2 py-1 rounded">Robotics</span>
                </div>
      ...
      <section className="bg-gradient-to-r from-orange-500 to-yellow-600 py-20">
        <div className="container mx-auto px-6">
          <div className="text-center text-white">
            ...
            <p className="text-xl mb-8 opacity-90">Solve real problems, win prizes, and get discovered by industry leaders</p>
            ...
            <div className="mt-8">
              ...
              <p className="text-xl">Your next breakthrough starts here.</p>
            </div>
          </div>
        </div>
      </section>
