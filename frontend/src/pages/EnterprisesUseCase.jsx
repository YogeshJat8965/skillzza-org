              ...
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
                <div className="flex flex-col lg:flex-row">
                  <div className="lg:w-1/2 p-8 lg:p-12">
                    ...
                    <h4 className="text-xl font-semibold text-orange-600 mb-4">Hire Twin& Skillzza Marketplace Integration</h4>
              ...
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
                <div className="flex flex-col lg:flex-row">
                  <div className="lg:w-1/2 p-8 lg:p-12">
                    ...
                    <h4 className="text-xl font-semibold text-orange-600 mb-4">Talent Twin Partnerships</h4>
                    <ul className="space-y-3 text-gray-700 mb-6">
                      <li className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-orange-500 rounded-full mt-2 flex-shrink-0"></div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center bg-gradient-to-br from-green-50 to-blue-50 p-8 rounded-2xl border border-green-200">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Reduction</h3>
              ...
              <div className="text-center bg-gradient-to-br from-yellow-50 to-orange-50 p-8 rounded-2xl border border-yellow-200">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Improvement</h3>
              ...
              <div className="text-center bg-gradient-to-br from-purple-50 to-pink-50 p-8 rounded-2xl border border-purple-200">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Increase</h3>
