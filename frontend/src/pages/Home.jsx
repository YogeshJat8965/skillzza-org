...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* ===== The Numbers Don't Lie Section (with Animated Counters) ===== */}
      <section className="bg-white py-24">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-gray-50 p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-600">In 2025, nearly 69% of organizations report ongoing difficulties recruiting for full-time roles reflecting persistent hiring challenges across sectors.</p>
            </div>
            <div className="bg-gray-50 p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-600">While 74% of employees use AI tools regularly, only 33% have received any formal training to use these tools effectively and safely.</p>
            </div>
            <div className="bg-gray-50 p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-600">By 2030, an estimated 59% of employees will need reskilling or upskilling, marking a continued upward trend from the 50% forecast for 2025.</p>
            </div>
            <div className="bg-gray-50 p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-600">Skill gaps are the biggest barrier to business transformation, with 85% of employers planning to prioritize upskilling their workforce.</p>
            </div>
          </div>
        </div>
      </section>
