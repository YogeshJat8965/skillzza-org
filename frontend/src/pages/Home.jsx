...
export default function Home() {
  ...
  return (
    <>
      <section
        className="text-white py-24 relative overflow-hidden bg-no-repeat"
        style={{
      ...
      >
        <div className="container mx-auto px-6 relative z-10 flex items-center h-full min-h-[450px]">
          <div className="w-full md:w-1/2 text-left">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-4 tracking-wide">
              <span className="text-orange-400">Bolstering Students</span>
              <br />
              an Employability, Innovation &<br />Creative Skills.
            </h1>
            <p className="text-lg md:text-xl mb-8">
              An AI driven up-Skilling platform aligned with UN's Sustainable Development Goals (SDG)
            </p>
            <button className="bg-orange-400 text-white font-semibold py-3 px-8 rounded-lg shadow-lg hover:bg-orange-500 transition-all duration-300 transform hover:scale-105">
      ...
      >
        ...
        <div className="container mx-auto px-6 relative z-10">
          {/* <div className="flex justify-center mb-12 md:mb-16">
            <img src="/partner-bg.png" alt="Business people shaking hands" className="w-full max-w-4xl h-auto rounded-lg shadow-xl" />
          </div> */}
          <div className="flex flex-col md:flex-row items-center justify-center gap-16 md:gap-24">
            <div className="md:w-1/2 text-center md:text-left text-white">
              <h2 className="text-4xl md:text-5xl text-black font-bold leading-tight mb-6">
                Partner with us <br /> To make a Difference
              </h2>
              <p className="text-lg md:text-xl text-black max-w-md mx-auto md:mx-0">
            ...
            <div className="md:w-1/2 w-full max-w-md bg-white p-8 md:p-10 rounded-lg shadow-2xl text-gray-800">
              <form className="space-y-6">
                ...
                <button type="submit" className="w-full bg-black text-white py-4 rounded-md font-bold text-lg hover:bg-gray-800">
                  Get Started
                </button>
              </form>
            </div>
          ...
          <div className="relative w-full overflow-hidden">
            <div className="flex w-[200%] animate-slide-logos gap-8">
              <div className="flex items-center gap-8">
                ...
                <div className="flex-shrink-0 w-48 h-32 bg-white rounded-lg shadow-sm flex items-center justify-center p-4 border"><img src="/ai_lifebot_logo.jpeg" alt="AI LifeBot" className="h-08 w-auto" /></div>
                <div className="flex-shrink-0 w-48 h-32 bg-white rounded-lg shadow-sm flex items-center justify-center p-4 border"><img src="/microsoft_logo.png" alt="Microsoft" className="h-20 w-auto" /></div>
              </div>
              <div className="flex items-center gap-8">
                <div className="flex-shrink-0 w-48 h-32 bg-white rounded-lg shadow-sm flex items-center justify-center p-4 border"><img src="/redhat_logo.jpeg" alt="Red Hat" className="h-10 w-auto" /></div>
                <div className="flex-shrink-0 w-48 h-32 bg-white rounded-lg shadow-sm flex items-center justify-center p-4 border"><img src="/Google_logo.svg.png" alt="Google" className="h-12 w-auto" /></div>
